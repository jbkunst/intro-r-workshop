...
dgeo <- mutate(dgeo, personas_miles = personas/100)

md <- mapdeck(token = token, height = 800,
               zoom = 8, location = c(-70.65664, -33.45327)) %>%
  add_polygon(
    data = dgeo, 
...
```{r, echo=FALSE}
widgetframe::frameWidget(md, height = 700)
```
